...
import { Menu, DollarSign , FileText, X, Bell, MessageCircle, User, LogOut, Building2, CircleDollarSign } from 'lucide-react';
...
export const Navbar: React.FC = () => {
  ...
  const navLinks = [
    ...
    {
      path: user?.role == 'entrepreneur'  ? '/Payment1' : '/Payment2',
